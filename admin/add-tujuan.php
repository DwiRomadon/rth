                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="../function/admin/tujuan/tambah_tujuan.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="kodetujuan" placeholder="Text..." class="form-control"><small class="form-text text-muted">Ex : A.5.1.1</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Kontrol Keamanan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nama" placeholder="Text..." class="form-control"><small class="form-text text-muted">Ex : Kebijakan untuk kemanan informasi</small></div>
                                    </div>
