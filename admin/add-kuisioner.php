                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="../function/admin/kuisioner/tambah_kuisioner.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Kode Tujuan</label></div>
                                        <div class="col-12 col-md-9">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea name="kuisioner" id="textarea-input" rows="9" placeholder="Text..." class="form-control"></textarea></div>
                                    </div>
